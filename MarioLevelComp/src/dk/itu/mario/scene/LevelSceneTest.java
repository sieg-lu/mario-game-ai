...
import dk.itu.mario.Test.TestLevelGenerator;
...
import dk.itu.mario.yufanlu_level.MyLevelGenerator;
...
public class LevelSceneTest extends LevelScene{
			...
			public void init() {
		        ...
		        if(level==null)
		        	if(isCustom){
//                        LevelGenerator clg = new CustomizedLevelGenerator();
                        LevelGenerator clg = new MyLevelGenerator(256, 16);
